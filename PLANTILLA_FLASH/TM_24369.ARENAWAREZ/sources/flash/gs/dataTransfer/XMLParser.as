class gs.dataTransfer.XMLParser
{
	...
	function parseLoadedXML(success_boolean) {
		...
		var _local9 = _xml;
		_root.xmlNodes = _local9;
		var _local3 = _local9.firstChild.firstChild;
		var _local8 = _local9.firstChild.lastChild;
		_local9.firstChild.obj = _results_obj;
		while (_local3 != undefined) {
			if ((_local3.nodeName == null) && (_local3.nodeType == 3)) {
				_local3.parentNode.obj.value = searchAndReplace(_local3.nodeValue, "\r\n", "");
			} else {
				var _local5 = {};
				for (var _local7 in _local3.attributes) {
					_local5[_local7] = _local3.attributes[_local7];
				}
				var _local6 = _local3.parentNode.obj;
				if (_local6[_local3.nodeName] == undefined) {
					_local6[_local3.nodeName] = [];
				}
				_local3.obj = _local5;
				_local6[_local3.nodeName].push(_local5);
			}
			if (_local3.childNodes.length > 0) {
				_local3 = _local3.childNodes[0];
			} else {
				var _local4 = _local3;
				while ((_local4.nextSibling == undefined) && (_local4.parentNode != undefined)) {
					_local4 = _local4.parentNode;
				}
				_local3 = _local4.nextSibling;
				if (_local4 == _local8) {
					_local3 = undefined;
				}
			}
		}
		_onComplete_func(true, _results_obj, _local9);
	}
