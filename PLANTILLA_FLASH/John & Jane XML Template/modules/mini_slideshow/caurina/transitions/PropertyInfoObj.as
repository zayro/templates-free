class caurina.transitions.PropertyInfoObj
{
    ...
    function clone()
    {
        var _loc2 = new caurina.transitions.PropertyInfoObj(valueStart, valueComplete, originalValueComplete, arrayIndex, extra, isSpecialProperty, modifierFunction, modifierParameters);
        return (_loc2);
    } // End of the function
    function toString()
    {
