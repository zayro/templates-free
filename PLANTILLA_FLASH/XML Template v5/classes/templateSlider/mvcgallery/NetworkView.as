...
class templateSlider.mvcgallery.NetworkView extends AbstractView {
...
function onResize(){
	...
	this.__maxColumns=5//Math.round(  (widthNetwork/(ThumbView.getWidth()+this.__spaceX)) )
	this.__maxRows=Math.ceil(  (heightNetwork/(ThumbView.getHeight()+this.__spaceY)) )
	}
    }	
