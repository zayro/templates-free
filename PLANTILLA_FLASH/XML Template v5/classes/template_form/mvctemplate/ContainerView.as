...
class template_form.mvctemplate.ContainerView extends AbstractView {
...
function getHeight(){
	return this.__oldRows.getBounds(this.__oldRows._parent).yMin+this.__oldRows.getHeight()
}
