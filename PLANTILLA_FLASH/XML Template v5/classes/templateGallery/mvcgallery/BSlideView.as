...
class templateGallery.mvcgallery.BSlideView extends AbstractView {
...
function change_color() {
		 ...
		 ///bcg
	NewColor.setColor(mc_slide.bcg, Configuration.COLOR_BACKGROUND_BUTTON.split(",")[0])
	mc_slide.bcg._alpha = Configuration.COLOR_BACKGROUND_BUTTON.split(",")[1]
	 
////symbol mc_play
 NewColor.setColor(mc_slide.mc_play, Configuration.COLOR_SYMBOL_BUTTON.split(",")[0])
 mc_slide.mc_play._alpha = Configuration.COLOR_SYMBOL_BUTTON.split(",")[1]
 
////symbol mc_pause
 NewColor.setColor(mc_slide.mc_pause, Configuration.COLOR_SYMBOL_BUTTON.split(",")[0])
 mc_slide.mc_pause._alpha = Configuration.COLOR_SYMBOL_BUTTON.split(",")[1]
...
private function setPositionSlide(){
	...
	this._x=image._x+image.getWidth()/2-40
