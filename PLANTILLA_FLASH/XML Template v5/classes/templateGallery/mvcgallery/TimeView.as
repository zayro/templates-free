...
class templateGallery.mvcgallery.TimeView extends AbstractView {
...
function onLoad(){
	///Stage.addListener(this)	
	 ...
	 ///bcg
	 NewColor.setColor(spiral, Configuration.COLOR_SLIDE_CIRCLE.split(",")[0])
	 spiral._alpha = Configuration.COLOR_SLIDE_CIRCLE.split(",")[1]
