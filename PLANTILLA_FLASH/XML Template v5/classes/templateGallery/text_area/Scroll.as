...
class templateGallery.text_area.Scroll extends MovieClip {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function setColorScroll(color_){
...
//////////////////////////////////////////////////////////////////////////
      ...
      function set proportion(f){
		...
		scrollHeight=Math.round(__drag*__proportion)
		size()
	}
...
//////////////////////////////////////////////////////////////////////////
	...
	function size(){
	    __drag=__height-(arrow_down._height+arrow_up._height)
		this.mc_scroll._y=0
		arrow_down._y=__drag
		arrow_up._y=-arrow_up._height
...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	return __first+( this.mc_scroll._y / (__drag-scrollHeight) )*(__last-__first)
	}
