	...
	$.fn.nivoSlider = function(options) {
		...
		return this.each(function() {
			...
			if(settings.directionNav){
				slider.append('<div class="nivo-directionNav"><a class="nivo-prevNav"><img src="./images/icon_arrow-left.png" alt="&lt;" /></a><a class="nivo-nextNav"><img src="./images/icon_arrow.png" alt="&gt;" /></a></div>');
