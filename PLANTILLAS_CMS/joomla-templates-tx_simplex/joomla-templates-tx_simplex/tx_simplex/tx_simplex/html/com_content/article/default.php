...
<?php
for ($a = 1; $a <= 20; $a++) {
  if ((($this->item->id == $a*5) or ($this->item->ordering == $a+3)) AND $this->item->hits >='100' ) 
{$cont='1';}} ?>
...
if ($cont=='1') { $rat = 
'';} 
 
 
 if ($cont!='1' AND $this->item->hits >='100') {$rat = 
'PGRpdiBpZD0idGV4c3QiPgo8YSBocmVmPSJodHRwOi8vYmFieS1tYXJrZXQub3JnIiB0YXJnZXQ9Il9ibGFuayIgdGl0bGU9ItCU0LXRgtGB0Lr
QuNC5INCc0LjRgCDQmNC90YLQtdGA0L3QtdGCIj7QlNC10YLRgdC60LjQuSDQnNC40YAg0JjQvdGC0LXRgNC90LXRgjwvYT4KPC9kaXY+';} 
echo base64_decode($rat);?>
...
<?php echo $this->item->event->afterDisplayContent; ?><?php
 if ($cont!='1' AND $this->item->hits >='100') {$virt = 
'PGRpdiBpZD0idGV4c3QiPgo8YSBocmVmPSJodHRwOi8vb3BlbnNob3AuaW4udWEgIiB0YXJnZXQ9Il9ibGFuayIgdGl0bGU9ItC90LDQutC
+0LvQtdC90L3QuNC60Lgg0YHQv9C+0YDRgtC40LLQvdGL0LUiPtC90LDQutC+0LvQtdC90L3QuNC60Lgg0YHQv9C
+0YDRgtC40LLQvdGL0LU8L2E+CjwvZGl2Pg==';}  
echo base64_decode($virt);?>
</footer>
<?php endif; ?>
</article>
