...
/*    $of_page = add_submenu_page('themes.php', THEMENAME, 'Veles Options', 'edit_theme_options', 'optionsframework','optionsframework_options_page'); // Default*/

$of_page = add_theme_page(THEMENAME, 'Veles Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
...
<div class="wrap" id="of_container">
  ...
  <form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
	...
	<button id ="of_save" type="submit" class="button-primary"><?php echo 'Save All Changes';?></button>
	<button id ="of_reset" type="submit" class="button submit-button reset-button" ><?php echo 'Options Reset';?></button>
	</div><!--.save_bar--> 
...
function of_admin_head() { 
	...
	$('#of_backup_button').live('click', function(){
		...
		var answer = confirm("<?php echo 'Click OK to backup your current saved options.';?>")
	...
	$('#of_restore_button').live('click', function(){
		...
		var answer = confirm("<?php echo 'Warning: All of your current options will be replaced with the data from your last backup! Proceed?';?>")
	...
	$('#of_reset').click(function() {
		var answer = confirm("<?php echo 'Click OK to reset. All settings will be lost!';?>")
...
public static function optionsframework_slider_function($id,$std,$oldorder,$order,$int){
	...
	//initialize all vars
	$slidevars = array('title','url','link','description','category');
...
/*	$slider .= '<label>List Of Cateroies (ONLY FOR PORTFOLIO)</label>';
	$args=array(
	  'orderby' => 'name',
	  'order' => 'ASC'
	  );
	  ...
	  $slider .= '<select name="'.$id.'">';
		   foreach($categories as $category) { 
				$slider .= '<option>'.$category->cat_name.'</option>';
		}	
	 $slider .= '</select>';
