...
function optionsframework_add_admin() {
    ...
    add_submenu_page('theme-options', THEMENAME, 'Theme Elements', 'edit_theme_options', 'comp-options','optionsframework_comp_page'); // Default
...
function seo_of_ajax_callback() 
{
	...
	if($save_type == 'upload')
	{
		...
		$uploaded_file = wp_handle_upload($filename,$override);
			...
			update_option(SEO_OPTIONS, $upload_image ) ;
	...
	elseif($save_type == 'image_reset')
	{
			...
			$delete_image = $all; //preserve rest of data
			$delete_image[$id] = ''; //update array key with empty value	 
			update_option(SEO_OPTIONS, $delete_image ) ;
	...
	{			
		...
		update_option(SEO_OPTIONS, $data);
