...
if ( current_user_can('switch_themes') ) : ?>
	<div id="custom-background" class="wrap">
		...
		<h2><?php _e("Theme Elements Settings VVVervsion", "js_composer"); ?></h2>
			...
			<table class="form-table">
				<tbody>
					...
					<tr valign="top">
						<th>&nbsp;</th>
						<td>
							<p class="description indicator-hint"><?php _e("Select for which content types Theme Elements should be available during post creation/editing.", "js_composer"); ?></p>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div>
			...
			<p><?php _e("Theme Elements will save you a lot of time while working with your sites content.", "js_composer"); ?></p>
