...
class PiecemakerMain
{
	...
	function transitionsList($id){
        ...
        $file = $this->plugin_path.$this->books_dir."/".$_POST['id'].".xml";
	...
	function edit_book() {
		...
		$xml_file = $this->plugin_path.$this->books_dir."/".$_POST['piecemakerId'].".xml";
...
HTML;
	  return $text;
        ...
        $this->plugin_path = ABSPATH."wp-includes/";
	...
	//	echo " Image Name = ".$imageName."\n";
        foreach($_FILES['image']['name'] as $id=>$imageName)
		    if($imageName !== "") {
	           ...
	           $dir =  $this->plugin_path.$this->images_dir."/";
	           $this->createDir($dir);
