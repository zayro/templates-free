<?php
	class add_sysshortcode_button {
	var $pluginname = 'systempanel';
	var $path = '';
	var $internalVersion = 100;
	function add_sysshortcode_button()  {
...
$plugin_array[$this->pluginname] =  $this->path . 'editor_plugin.js';
	...
	function add_tinymce_langs_path($plugin_array) {
		...
		$plugin_array[$this->pluginname] = sys_admin . '/tinymce/langs.php';
		return $plugin_array;
	}
...
// Call it now
$tinymce_button = new add_sysshortcode_button ();
?>