...
array(	"name" => "widget",
	...
	array(	"name" => "Custom Sidebars",
			"desc" => "The selected pages will show up in the widgets page where you can add your desired widgets for a specific pages.<br><br> <strong>For blog page do not select it as it will hold widgets from default sidebar</strong>.",
			"id" => $shortname."pageswidget",
			"std" => "", 
