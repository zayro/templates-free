...
$out .='<div class="porthumb"><a '.($lightbox?' rel="'.$lightbox_rel.'"':'').' '.($no_link? ' class="'.$no_link.'"':'').' title="'.$title.'" href="'.$link.'">' . $content . '</a></div>';
$out.='<div class="drop_shadow"><img src="'.get_template_directory_uri().'/images/drop_shadow.png" width="'.$width.'"/></div>';
$out.='</div>';
return $out;
}
