...
/*---------------------------------*/
	if(!is_admin()){
		wp_enqueue_style('sys_comments', get_template_directory_uri() . '/css/comments.css', false, '3.0', 'all');
...
function system32_enqueue_scripts() {
	...
	if(!is_admin()){
		wp_enqueue_script( 'jquery-main', sys_scripts .'/jquery-1.5.1.min.js');
		wp_enqueue_script( 'jquery-easing', sys_scripts .'/jquery.easing.1.3.js');
		wp_enqueue_script( 'jquery-tools', sys_scripts .'/	jquery.tools.min.js');
		wp_register_script('jquery_map',sys_scripts.'/jquery.gmap.js');
		wp_enqueue_script( 'jquery-preload', sys_scripts .'/jquery.preloadify.min.js');
		/*---------------------------------*/
		...
		wp_enqueue_script( 'sys-slider-js', sys_scripts.'/sys_slider.js');
		}
		...
		wp_enqueue_script( 'jquery-validate', sys_scripts .'/jquery.validate.js');	
