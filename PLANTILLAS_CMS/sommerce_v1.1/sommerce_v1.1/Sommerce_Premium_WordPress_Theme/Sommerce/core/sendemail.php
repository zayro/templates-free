...
function yiw_module( $form, $echo = true )
{
	...
	$html .= "\t\t\t\t<input type=\"submit\" name=\"yiw_sendemail\" value=\"" . yiw_get_option( 'contact_form_submit_label_' . $form, __( 'send message', 'yiw' ) ) . "\" class=\"sendmail " . get_option( 'bl_contact_form_submit_alignment_' . $form, __( 'alignright', 'yiw' ) ) . "\" />";
	$html .= "\t\t\t</li>\n";
...
add_action( 'init', 'yiw_add_contact_scripts' );
