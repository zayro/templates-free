        ...
        foreach($values as $value)
        {
            ...
            switch ( $value['type'] ) 
            {
                ...
                ?>
                    ...
                    <div class="rm_option rm_input rm_text">
														...
														<tbody>
															...
															<tr>
																<td colspan="4">&nbsp;<strong><?php _e('Slide Title', 'yiw') ?>:</strong><br> 
																	<input type="text" value="<?php echo isset( $field['slide_title'] ) ? $field['slide_title'] : '' ?>" alt="<?php _e('Slide Title', 'yiw') ?>" class="ss-ImageTitle" name="<?php yiw_option_name( $value['id'] ); ?>[<?php echo $id ?>][slide_title]">
																</td>
															</tr>
															<?php break; 
                                                                case 'caption' : ?>
															...
															<tr>
																<td align="left" colspan="3" class="rm_upload">
																	...
																	<input type="button" value="<?php _e('Upload Image', 'yiw') ?>" id="<?php yiw_option_id( $value['id'] ); ?>-upload" />
															...
															<?php break; 
                                                                default :
                                                                    do_action( 'yiw_slider_config_' . $config, $value );
                                                            } endforeach; ?>                
															<tr>
