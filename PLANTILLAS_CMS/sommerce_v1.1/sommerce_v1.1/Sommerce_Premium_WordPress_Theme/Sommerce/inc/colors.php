	...
	'creative-navigation' => array(    
		...
		'options' => array(
			...
			'creative-navigation-tab-active' => array(    
				'default' => '#fff',
				'css_role' => '#nav.creative li.current-menu-item a', 
				'css_attr' => 'background-color', 
	...
	'store-single' => array(    
		...
		'options' => array( 
			...
			'store-single-bg-color-add-cart' => array(    
				'default' => '#A1CB4F',
				'css_role' => 'a.button.checkout, .button-alt', 
				'css_attr' => 'background-color', 
			...
			'store-single-bg-color-add-cart-hover' => array(    
				'default' => '#b2dc60',
				'css_role' => 'a.button.checkout:hover, .button-alt:hover, a.button:hover,button.button:hover,input.button:hover,#review_form #submit:hover', 
				'css_attr' => 'background-color', 
