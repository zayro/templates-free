...
class RecentProjWidget extends WP_Widget
{
	...
	function RecentProjWidget(){
		...
		add_image_size('widget_recent_proj', 260, 115, true);
	}
...
?>
		...
		<?php while($loop->have_posts()): $loop->the_post(); ?>
			<li>
				<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('widget_recent_proj', array('title' => false, 'class' => 'pic')); ?></a>
				<?php if ($show_title): ?><b><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></b><?php endif; ?>
