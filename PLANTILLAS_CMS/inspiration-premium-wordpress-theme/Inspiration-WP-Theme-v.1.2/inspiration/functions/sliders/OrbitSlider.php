...
class OrbitSlider extends BaseSlider {
	...
	public function __construct() {
		add_image_size('slider_orbit', 952, 392, true);
		parent::__construct();
	}
	...
	public function scripts() {
		wp_register_style('css_slider_orbit', get_bloginfo('template_directory') . '/sliders/orbit-slider/orbit-slider.css');
		wp_register_script('js_slider_orbit', get_bloginfo('template_directory') . '/sliders/orbit-slider/jquery.orbit.js', array('jquery'));
