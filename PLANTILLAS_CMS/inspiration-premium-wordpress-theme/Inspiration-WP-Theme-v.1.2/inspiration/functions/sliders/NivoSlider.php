...
class NivoSlider extends BaseSlider {
	...
	public function __construct() {
		add_image_size('slider_nivo', 952, 392, true);
	...
	public function scripts() {
		wp_register_style('css_slider_nivo', get_bloginfo('template_directory') . '/sliders/nivo-slider/nivo-slider.css');
		wp_register_script('js_slider_nivo', get_bloginfo('template_directory') . '/sliders/nivo-slider/jquery.nivo.slider.js', array('jquery'));
