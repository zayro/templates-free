...
class CoinSlider extends BaseSlider {
	...
	public function __construct() {
		add_image_size('slider_coin', 952, 392, true);
	...
	public function scripts() {
		wp_register_style('css_slider_coin', get_bloginfo('template_directory') . '/sliders/coin-slider/coin-slider.css');
		wp_register_script('js_slider_coin', get_bloginfo('template_directory') . '/sliders/coin-slider/coin-slider.js', array('jquery'));
