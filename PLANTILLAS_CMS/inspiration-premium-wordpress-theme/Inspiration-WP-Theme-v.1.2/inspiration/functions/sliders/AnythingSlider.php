...
class AnythingSlider extends BaseSlider {
	...
	public function __construct() {
		...
		add_image_size('slider_anything_small', 640, 392, true);
	...
	public function scripts() {
		wp_register_style('css_slider_anything', get_bloginfo('template_directory') . '/sliders/anything-slider/anything-slider.css');
		wp_register_script('js_slider_anything', get_bloginfo('template_directory') . '/sliders/anything-slider/jquery.anythingslider.js', array('jquery'));
