...
class Serie3Slider extends BaseSlider {
	...
	public function __construct() {
		add_image_size('slider_serie3', 952, 392, true);
	...
	public function scripts() {
		wp_register_style('css_slider_s3', get_bloginfo('template_directory') . '/sliders/serie3-slider/s3slider.css');
		wp_register_script('js_slider_s3', get_bloginfo('template_directory') . '/sliders/serie3-slider/s3Slider.js', array('jquery'));
