...
class RoundAboutSlider extends BaseSlider {
	...
	public function __construct() {
		add_image_size('slider_roundabout', 416, 312, true);
		parent::__construct();
	}
	...
	public function scripts() {
		wp_register_style('css_slider_roundabout', get_bloginfo('template_directory') . '/sliders/roundabout-slider/roundabout.css');
		wp_register_script('js_slider_roundabout', get_bloginfo('template_directory') . '/sliders/roundabout-slider/jquery.roundabout.js', array('jquery'));
