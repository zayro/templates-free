...
if(isset($data['logo_upload']) && !empty($data['logo_upload'])) {
	...
	elseif ( $data['logo_size'] == 'contain' ) {
		...
		?>
		body header#header #logo a ,header#header.style2 #logo a , header#header.style3 #logo a{min-height: 95px;
			padding: 0 25px;
			line-height: 95px;
			text-align: center;
			}
...
.sidebar .widget ul.pagenav li a:hover{background-color:<?php echo $data['zn_main_color'];?>;}
