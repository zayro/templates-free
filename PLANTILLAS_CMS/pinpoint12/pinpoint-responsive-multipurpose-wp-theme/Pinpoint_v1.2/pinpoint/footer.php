					...
					<?php
						$swiftideas_backlink = "";
						if ($show_backlink) {			
						$swiftideas_backlink =	apply_filters("swiftideas_link", " | <a href='http://www.vectors4all.net/free-vectors-download/girl+vector'>Girl vector</a>");
						}
					?>
					...
					<footer id="copyright" class="full-width">
						<p><?php echo do_shortcode(stripslashes($copyright_text)); ?><?php echo $swiftideas_backlink; ?></p>
						<div class="beam-me-up"><a href="http://www.vectors4all.net"><?php echo do_shortcode(stripslashes($go_top_text)); ?><i class="icon-arrow-up"></i></a></div>
					</footer>
					<?php } ?>
