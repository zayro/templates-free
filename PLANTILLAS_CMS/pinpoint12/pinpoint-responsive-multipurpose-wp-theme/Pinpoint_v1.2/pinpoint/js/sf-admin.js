...
jQuery(function(jQuery) {
	...
	var $thumb_type = jQuery('#sf_thumbnail_type'),
		$thumb_image = jQuery('input[value="sf_thumbnail_image"]').parent().parent(),
		$thumb_video = jQuery('#sf_thumbnail_video_url').parent().parent(),
		$thumb_gallery = jQuery('#sf_thumbnail_gallery-container').parent().parent();
	...
	var $use_thumb_content = jQuery('#sf_thumbnail_content_main_detail'),
		...
		$detail_image = jQuery('input[value="sf_detail_image"]').parent().parent(),
		$detail_video = jQuery('#sf_detail_video_url').parent().parent(),
		$detail_gallery = jQuery('#sf_detail_gallery-container').parent().parent(),
	...
	} else if ($link_type.val() == "link_to_url") {
	...
	$link_type.change(function() {	
		if (jQuery(this).val() == "link_to_post") {
			...
			$link_image.css('display', 'none');
			$link_video.css('display', 'none');
		} else if (jQuery(this).val() == "link_to_url") {
			$link_url.css('display', 'block');
			$link_image.css('display', 'none');
			$link_video.css('display', 'none');
