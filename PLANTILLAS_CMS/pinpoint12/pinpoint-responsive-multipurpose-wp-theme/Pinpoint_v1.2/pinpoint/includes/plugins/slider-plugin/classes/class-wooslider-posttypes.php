...
class WooSlider_PostTypes {
	...
	public function setup_slide_post_type () {
		...
		$args = array(
		    ...
		    'menu_icon' => esc_url( get_template_directory_uri() . '/includes/plugins/slider-plugin/assets/images/icon_slide_32.png' ), 
	...
	private function setup_post_type_labels_base () {
		...
		$this->labels['slide'] = array( 'singular' => __( 'Slide', 'wooslider' ), 'plural' => __( 'Slides', 'wooslider' ), 'menu' => __( 'Sliders', 'wooslider' ) );
