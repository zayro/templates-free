...
//    );
    				...
    				'fields' => array(
    					...
    					array(
    						...
    						'options' => array(
    										...
    										$args['bg_image_path'] . 'cardboard.png' => $args['bg_image_path'] . 'cardboard.png',
    										...
    										$args['bg_image_path'] . 'concrete_wall_2.png' => $args['bg_image_path'] . 'concrete_wall_2.png',
    										$args['bg_image_path'] . 'concrete_wall.png' => $args['bg_image_path'] . 'concrete_wall.png',
    										...
    										$args['bg_image_path'] . 'darth_stripe.png' => $args['bg_image_path'] . 'darth_stripe.png',
    										$args['bg_image_path'] . 'diagonal-noise.png' => $args['bg_image_path'] . 'diagonal-noise.png',
    										$args['bg_image_path'] . 'exclusive_paper.png' => $args['bg_image_path'] . 'exclusive_paper.png',
    										...
    										$args['bg_image_path'] . 'large_leather.png' => $args['bg_image_path'] . 'large_leather.png',
    										...
    										$args['bg_image_path'] . 'soft_wallpaper.png' => $args['bg_image_path'] . 'soft_wallpaper.png',
    										...
    										$args['bg_image_path'] . 'wood_1.png' => $args['bg_image_path'] . 'wood_1.png',
    										$args['bg_image_path'] . 'wood_pattern.png' => $args['bg_image_path'] . 'wood_pattern.png',
    ...
    $sections[] = array(
    				...
    				'fields' => array(
    					...
    					array(
    						...
    						'desc' => '',
    						'std' => "Copyright [the-year] | Pinpoint by <a href='http://www.swiftpsd.com'>Swift Ideas</a> | Powered by [wp-link]"
    						),
    					array(
    						'id' => 'show_backlink',
    						'type' => 'button_set',
    ...
    $sections[] = array(
    				'icon' => Redux_OPTIONS_URL.'img/slider.png',
    				'title' => __('Slider Options', Redux_TEXT_DOMAIN),
    				'desc' => __('<p class="description">These are the options for the sliders used in the theme.</p>', Redux_TEXT_DOMAIN),
    				'fields' => array(
    					array(
    						'id' => 'showcase_slide_duration',
    						'type' => 'text',
    						'title' => __('Slider Duration', Redux_TEXT_DOMAIN),
    						'sub_desc' => "The duration which the slide is viewable for before it's transitioned to the next one. The time is stated in milliseconds (e.g. 6 seconds would be 6000 milliseconds).",
    						'desc' => '',
    						'validate' => 'numeric',
    						'std' => '6000',
    						'class' => 'mini'
    					...
    					array(
    						'id' => 'showcase_transition',
    						'type' => 'select',
    						'title' => __('Showcase Transition Type', Redux_TEXT_DOMAIN), 
    						'sub_desc' => __('The transition type between slides on the sliders.', Redux_TEXT_DOMAIN),
    						'desc' => '',
    						'options' => array('fade' => 'Fade','slide' => 'Slide'),
    						'std' => 'slide'
    						),
    					array(
    						'id' => 'showcase_transition_duration',
    						'type' => 'text',
    						'title' => __('Slider Transition Duration', Redux_TEXT_DOMAIN),
    						'sub_desc' => "The duration which the slide transitions for. The time is stated in milliseconds.",
    						'desc' => '',
    						'validate' => 'numeric',
    						'std' => '500',
    						'class' => 'mini'
    					...
    					array(
    						...
    						'type' => 'button_set',
    						'title' => __('Slider Autoplay', Redux_TEXT_DOMAIN), 
    						'sub_desc' => __('Set the sliders to auto rotate', Redux_TEXT_DOMAIN),
    						'desc' => '',
    						'options' => array('1' => 'On','0' => 'Off'),
    						'std' => '1'
    						),
    ...
    $tabs['documentation'] = array(
    				...
    				'content' => '<p>Documentation for Pinpoint is available here <a href="http://themes.swiftpsd.com/documentation/pinpoint" target="_blank">here</a>.</p>'
    				);
    ...
    $tabs['support'] = array(
    				...
    				'content' => '<p>If you need support for Pinpoint, please visit our support site <a href="http://support.swiftpsd.com" target="_blank">here</a>.</p>'
    				);				
