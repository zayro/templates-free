...
body, .masonry-items .blog-item .quote-excerpt, #commentform label, .contact-form label {
...
.blog-item .spacer, .mini-items .blog-item-details, .author-info-wrap, .related-wrap {
	border-color: <?php echo $section_divide_color; ?>;
}
.related-wrap {
...
<?php if ($use_custom_font_two) { ?>h1, h2, h3, h4, h5, .heading-font, .custom-caption p, span.dropcap1, span.dropcap2, span.dropcap3, span.dropcap4, .wpb_call_text, .impact-text, .testimonial-text {font-family: '<?php echo $google_font_two; ?>', sans-serif;}<?php } ?>
<?php if ($use_custom_font_impact) { ?>.wpb_call_text, .impact-text {font-family: '<?php echo $google_font_impact; ?>', sans-serif;}<?php } ?>
