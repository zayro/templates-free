...
define( 'NOTIFIER_THEME_NAME', 'wowway' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'wowway' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://rubenbristian.com/content/themeUpdates/wowway-notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
