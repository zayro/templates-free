...
function portfolioposttype() {
	...
	$labels = array(
		...
		'search_items' => __( 'Search Portfolio', 'wowway' ),
	...
	register_post_type( 'portfolio', $args );
	 ...
	 $taxonomy_portfolio_category_labels = array(
		'name' => _x( 'Categories', 'portfolioposttype' ),
		'singular_name' => _x( 'Category', 'portfolioposttype' ),
		'search_items' => _x( 'Search Categories', 'portfolioposttype' ),
		'popular_items' => _x( 'Popular Categories', 'portfolioposttype' ),
		'all_items' => _x( 'All Categories', 'portfolioposttype' ),
		'parent_item' => _x( 'Parent Category', 'portfolioposttype' ),
		'parent_item_colon' => _x( 'Parent Category:', 'portfolioposttype' ),
		'edit_item' => _x( 'Edit Category', 'portfolioposttype' ),
		'update_item' => _x( 'Update Category', 'portfolioposttype' ),
		'add_new_item' => _x( 'Add New Category', 'portfolioposttype' ),
		'new_item_name' => _x( 'New Category Name', 'portfolioposttype' ),
		'separate_items_with_commas' => _x( 'Separate Categories with commas', 'portfolioposttype' ),
		'add_or_remove_items' => _x( 'Add or remove Categories', 'portfolioposttype' ),
		'choose_from_most_used' => _x( 'Choose from the most used Categories', 'portfolioposttype' ),
		'menu_name' => _x( 'Categories', 'portfolioposttype' ),
    );
